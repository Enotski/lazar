  ...
  data() {
    return {
      ...
      items: [
        ...
        { key: "fourier", label: "Fourier Transform" },
        ...
        { key: "spectrum", label: "Welch's Method" },
        { key: "avg-spectrum", label: "Average spectrum" },
        { key: "filter-banks", label: "Filter banks" },
        { key: "farrow", label: "Farrow" },
        { key: "mel", label: "Mel-spectrum" },
        { key: "mfcc", label: "Mel-spectrum" },
